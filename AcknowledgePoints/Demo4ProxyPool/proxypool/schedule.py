...
from Demo4ProxyPool.proxypool.error import ResourceDepletionError
from Demo4ProxyPool.proxypool.getter import FreeProxyGetter
from Demo4ProxyPool.proxypool.setting import *
...
class ValidityTester(object):
    ...
    def test(self):
        ...
        try:
            ...
            tasks = [self._conn.put(proxy) for proxy in self._raw_proxies]
